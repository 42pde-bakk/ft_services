...
PHP
wp core install --allow-root --url=http://192.168.99.253:5050 --path=/www --title="ft_services" --admin_user=peer --admin_password=pass --admin_email=pde-bakk@student.codam.nl --skip-email
